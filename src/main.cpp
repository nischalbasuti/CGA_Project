...
SphereGlBody astroidGlBody(3);

SphereGlBody planet2AtmosphereGlBody(6.2);
...
Body sunBody(&sunGlBody, new btVector3(0, 0, 0), new btSphereShape(10), mass1, false);
...
PlanetBody astroidBody(150, &astroidGlBody, new btVector3(0, 0, -150), new btSphereShape(3), mass, false);
...
void setup(void) {
	...
	planet2AtmosphereGlBody.setColor(0,0,0,0.3);
...
void drawScene(void) {
	...
	// 	glPushMatrix();
	// 		glTranslatef(0,0,80);
	// 		glRotatef(moonBody.rotationY, 0, 1, 0);
	// 		glTranslatef(0,0,-80);
	// 		moonBody.draw();
	// 	glPopMatrix();
	// 	planet2Body.draw();
	...
	// glPushMatrix();
	// 	glRotatef(planet3Body.rotationY, 0,1,0);
	// 	planet3Body.draw();
	// glPopMatrix();
